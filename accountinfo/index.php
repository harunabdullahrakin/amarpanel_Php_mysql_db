...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if(isset($_POST["pfp"])){
        ...
        header("Location: ../accountinfo");
        die;
    }elseif(isset($_POST["user_id"]) && isset($_POST["coins"])){
        //save to database
        $query = "UPDATE users  SET coins='{$coins}' WHERE user_id = $id";

        mysqli_query($con, $query);

        header("Location: ../accountinfo");
        die;
    }elseif(isset($_POST["user_id"]) && isset($_POST["admin"])){
        //save to database
        $query = "UPDATE users  SET admin='{$add}' WHERE user_id = $id";
        ...
        <div class="sidebar pe-4 pb-3" >
            ...
            <div class="d-flex align-items-center ms-4 mb-4" >
                ...
                <div class="navbar-nav w-100" style="color:var(--test-color);">
                    ...
                    <a href="/accountinfo" class="nav-item nav-link active"><i class="fas fa-user-alt"></i> Account Info</a>
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Change Avatar</h6>
                            <form method="post" >
                                <div class="mb-3">
                                    <label class="form-label">New Image</label>
                                    <input class="form-control" type="pfp" class="pfp" name="pfp" placeholder="Enter Your Image Link" required>
                                </div>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post" >
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="password" class="password" name="password" placeholder="Enter Your Password" required>
                                </div>
                                <input class="btn btn-primary" Value='Update' name="submit" type="submit">
                            </form>
                        </div>
