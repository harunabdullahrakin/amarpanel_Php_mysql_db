...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if("1000" <= $coins){
        ...
        if($mvp == false){
            ...
            $query = "UPDATE users  SET mvp = 'true' WHERE user_id = $user_id";

            mysqli_query($con, $query);

            if($mvp == false){
                $query = "UPDATE users  SET coins = ( coins - 1000 ) WHERE user_id = $user_id";
...
<body style="background-color: var(--secondary-color);">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <p style="font-size: 39px;color: var(--test-color); text-align: center; background-color: rgb(110, 180, 110); border: 5px solid; border-radius: 30px;"><strong><span style="color: rgb(0, 225, 255); font-weight: 900;">MVP</span> Rank Shop</strong></p>
            </div>
