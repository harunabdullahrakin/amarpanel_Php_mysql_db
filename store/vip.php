...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if("500" <= $coins){
        ...
        if($vip == false){
            ...
            $query = "UPDATE users  SET vip = 'true' WHERE user_id = $user_id";

            mysqli_query($con, $query);

            if($vip == false){
                $query = "UPDATE users  SET coins = ( coins - 500 ) WHERE user_id = $user_id";

                mysqli_query($con, $query);
        
                header("Location: ../store/vip.php");

                echo "You've successfully bought VIP Rank";
            ...
            echo "You already have Vip Rank";
        }
    }else{
...
<body style="background-color: var(--secondary-color);">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <p style="font-size: 39px;color: var(--test-color); text-align: center; background-color: aqua; border: 5px solid; border-radius: 30px;"><strong><span style="color: greenyellow; font-weight: 900;">VIP</span> Rank Shop</strong></p>
            </div>
            ...
            margin-right: auto;">
                <div class="row g-4">
                    <form method="post" style="width: 36vh; height: 20vh;">
                        <div class=" rounded">
                            <input class="btn btn-primary" style="background-color: rgb(40, 224, 40); width: 31vh;" Value='Confirm' name="submit" type="submit">
