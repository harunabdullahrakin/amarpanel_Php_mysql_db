...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if("1500" <= $coins){
        ...
        if($mvpplus == false){
            ...
            $query = "UPDATE users  SET mvpplus = 'true' WHERE user_id = $user_id";

            mysqli_query($con, $query);

            if($mvpplus == false){
                $query = "UPDATE users  SET coins = ( coins - 1500 ) WHERE user_id = $user_id";

                mysqli_query($con, $query);
        
                header("Location: ../store/mvp+.php");
            ...
            echo "You already have MVP+ Rank";
        }
    }else{
        echo "Influence Balance";
    }
}
...
<body style="background-color: var(--secondary-color);">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <p style="font-size: 39px;color: var(--test-color); text-align: center; background-color: rgb(251, 255, 2); border: 5px solid; border-radius: 30px;"><strong><span style="color: rgb(255, 0, 234); font-weight: 900;">MVP<span style="color:red;">+</span></span> Rank Shop</strong></p>
            </div>
            <div class="container-fluid pt-4 px-4" style="max-width: fit-content;
            margin-left: auto;
            margin-right: auto;">
                    <div class="col-sm-6 col-xl-3" style="width: 45vh;">
            ...
            margin-right: auto;">
                <div class="row g-4">
                    <form method="post" style="width: 36vh; height: 20vh;">
                        <div class=" rounded">
                            <input class="btn btn-primary confirm" style="background-color: rgb(40, 224, 40); width: 31vh;" Value='Confirm' name="submit" type="submit">
                            <a href="/store/"><input class="btn btn-primary" style="background-color: rgb(235, 41, 41); margin-top: 10px;width: 31vh;" Value='Cancel' type="gg"></a>
                        </div>
                    </formv>
                </div>
            </div>
