...
<body style="background-color: var(--secondary-color);">
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown" >
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            font-family: Plus Jakarta Sans; height:70vh; background-color: var(--primary-color); border: 5px transparent; border-radius: 35px;  padding: 35px; width: 59vh;">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <p style="font-size: 39px;color: var(--test-color);"><strong>Welcome To The Store</strong></p>
            </div>
            <div class="container-fluid pt-4 px-4">
                <p style="font-size: 20px;color: var(--test-color); font-weight: 900;"><strong>Coins Shop</strong></p>
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3" style="width: 45vh;"><a href="vip.php">
                        <div class=" gg rounded d-flex align-items-center justify-content-between p-4" style=" overflow: hidden; background-color: rgba(250,245,249,255); border-radius: 5px;">
                        <img class="rounded-circle" src="https://dunb17ur4ymx4.cloudfront.net/packages/images/9f9aef1a97dd7a7061958a2d2dc72238e06a455c.png" alt="" style="width: 85px; height: 85px;">
                            <div class="ms-3" >
                                <p style="color: #e6ae47; font-weight: bold; font-size: 22px;">VIP Rank</p>
                                <p style="font-size: 17px; color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;500.00</p>
                            </div>
                        </div></a>
                    </div>
                    <div class="col-sm-6 col-xl-3" style="width: 45vh;"><a href="vip+.php">
                        <div class=" gg rounded d-flex align-items-center justify-content-between p-4" style=" overflow: hidden; background-color: rgba(250,245,249,255); border-radius: 5px;">
                        <img class="rounded-circle" src="https://dunb17ur4ymx4.cloudfront.net/packages/images/573d597eebcbfdc8c5485d6bf044abb60175c2c5.png" alt="" style="width: 85px; height: 85px;">
                            <div class="ms-3" >
                                <p style="color: #e6ae47; font-weight: bold; font-size: 22px;">Vip+ Rank</p>
                                <p style="font-size: 17px; color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;700.00</p>
                            </div>
                        </div></a>
                    </div>
                    <div class="col-sm-6 col-xl-3" style="width: 45vh;"><a href="mvp.php">
                        <div class=" gg rounded d-flex align-items-center justify-content-between p-4" style=" overflow: hidden; background-color: rgba(250,245,249,255); border-radius: 5px;">
                        <img class="rounded-circle" src="https://dunb17ur4ymx4.cloudfront.net/packages/images/1b734bae59b7cef0dbbfc1b43d1ceed19b9cfebf.png" alt="" style="width: 85px; height: 85px;">
                            <div class="ms-3" >
                                <p style="color: #e6ae47; font-weight: bold; font-size: 22px;">Mvp Rank</p>
                                <p style="font-size: 17px; color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;1000.00</p>
                            </div>
                        </div></a>
                    </div>
                    <div class="col-sm-6 col-xl-3" style="width: 45vh;"><a href="mvp+.php">
                        <div class=" gg rounded d-flex align-items-center justify-content-between p-4" style=" overflow: hidden; background-color: rgba(250,245,249,255); border-radius: 5px;">
                        <img class="rounded-circle" src="https://dunb17ur4ymx4.cloudfront.net/packages/images/be813e0264e79d198cc076ef686e4b6d1ed44c89.png" alt="" style="width: 85px; height: 85px;">
                            <div class="ms-3" >
                                <p style="color: #e6ae47; font-weight: bold; font-size: 22px;">Mvp+ Rank</p>
                                <p style="font-size: 17px; color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;1500.00</p>
                            </div>
                        </div></a>
                    </div>
                ...
                &nbsp;
                <p style="font-size: 20px;color: var(--test-color); font-weight: 900;"><strong>Available Plans</strong></p>
                <p style="font-size: 15px;color: var(--test-color); font-weight: 900;"><strong>Others</strong></p>
                <div class=" " style="width: 80vh;"><a href="">
                    <div class=" gg rounded d-flex align-items-center justify-content-between p-4" style=" overflow: hidden; background-color: rgba(250,245,249,255); border-radius: 5px;">
                    <img class="rounded-circle" src="https://i.ibb.co/ZmgRqZR/Shiney-Gold-Coins-Inv36.gif" alt="" style="width: 85px; height: 85px;">
                        <div class="ms-3" >
                            <p style="color: black; font-weight: 900; font-size: 20px;">Unlimited Coins</p>
                            <p style="color: rgb(253, 9, 253); font-weight: 700; font-size: 15px;">&nbsp;&nbsp;&nbsp;&nbsp;$ 0.99</p>
                        </div>
                    </div></a>
                </div>
            </div>
