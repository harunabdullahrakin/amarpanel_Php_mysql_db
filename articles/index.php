...
<body style="background-color: var(--secondary-color)">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <p style="font-size: 39px;color: var(--test-color);"><strong>Articles Related To The Panel</strong></p>
            </div>
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3" ><a href="/articles/newproject.php">
                        <div class="">
                        <img class="col-sm-6 col-xl-3" src="https://iili.io/JXwa7mx.md.png" style="border: 2px transparent; border-radius: 7px; width: 35vh;">
                        </div>
                        <div style="background-color: var(--primary-color); padding: 5px; border: 2px var(--primary-color); border-radius: 3px; width: 35vh;">
                        <p style="color: var(--test-color); text-align: center; font-weight: 700;    font-family: Lexend, sans-serif;">A New Website For MySelf </p>
                        <p style="color: var(--test-color); text-align: center; font-weight: 600;  font-size: small;  font-family: Lexend, sans-serif;">How about a website with multiple pages and show info about my pojects!</p>
                        </div></a>
                    </div>
