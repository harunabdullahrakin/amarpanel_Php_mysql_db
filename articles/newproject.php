...
<body style="background-color: var(--secondary-color)">
        ...
        <div class="sidebar pe-4 pb-3" >
            ...
            <div class="d-flex align-items-center ms-4 mb-4" >
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/articles" class="nav-item nav-link active"><i class="far fa-newspaper"></i> Articles</a>
                    <?php 
                                if("$ok" === "true"){
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown" ">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex" style="color:black;"><?php echo $row['user_name'];?></span>
                        </a>
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <p style="font-size: 39px;color: var(--test-color); text-align: center; font-family: Lexend, sans-serif;"><strong>A Website For My Projects</strong></p>
            </div>
            <div class="container-fluid pt-4 px-4">

                <p style="font-size: 24px;color: var(--test-color); margin-left: 9vh; font-family: Lexend, sans-serif; font-weight: 1200;">I'm going to try to make my 4th Website for My Projects to Show I'll link that website with my Discord Server. I'll make it like a portfolio but with some cool features.</p>
                <p> &nbsp;</p>

                <p style="text-align: center; font-size: 39px;color: var(--test-color);"> <strong>Here Is The Theme</strong> </p>        
                <p> &nbsp;</p>

                <p style="text-align: center; border: 2px transparent; border-radius: 20px;"><img style="" src="https://iili.io/JXNK1ov.md.png"></p>

                <p> &nbsp;</p>
                <p> &nbsp;</p>
                <p> &nbsp;</p>

                <p style="text-align: center;">Maybe I'll work on that Website Instead Of This Dashboard.</p>
                <p> &nbsp;</p>
                <p> &nbsp;</p>
                <p> &nbsp;</p>
