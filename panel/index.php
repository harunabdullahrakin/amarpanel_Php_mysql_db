...
<head>
    ...
    <meta content="Rakin's Panel" name="keywords">
    <meta content="Panel Verson #2 Of Rakin" name="description">
...
<body style="background-color: var(--secondary-color)">
        ...
        <div class="sidebar pe-4 pb-3" >
            ...
            <div class="d-flex align-items-center ms-4 mb-4" >
                ...
                <div class="navbar-nav w-100" style="color:var(--test-color);">
                ...
                <div class="d-flex align-items-center ms-4 mb-4" style="margin-top: 11vh; border: 1px transparent; background-color: #e5f3fb; padding: 30px; border-radius: 20px;">
                    ...
                    <div class="ms-3">
                        <h6 class="" style="color:black;"><?php echo $row['user_name'];?></h6>
                        <h6 class="" style="font-size: 9px;color:black;">                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M184,89.57V84c0-25.08-37.83-44-88-44S8,58.92,8,84v40c0,20.89,26.25,37.49,64,42.46V172c0,25.08,37.83,44,88,44s88-18.92,88-44V132C248,111.3,222.58,94.68,184,89.57ZM232,132c0,13.22-30.79,28-72,28-3.73,0-7.43-.13-11.08-.37C170.49,151.77,184,139,184,124V105.74C213.87,110.19,232,122.27,232,132ZM72,150.25V126.46A183.74,183.74,0,0,0,96,128a183.74,183.74,0,0,0,24-1.54v23.79A163,163,0,0,1,96,152,163,163,0,0,1,72,150.25Zm96-40.32V124c0,8.39-12.41,17.4-32,22.87V123.5C148.91,120.37,159.84,115.71,168,109.93ZM96,56c41.21,0,72,14.78,72,28s-30.79,28-72,28S24,97.22,24,84,54.79,56,96,56ZM24,124V109.93c8.16,5.78,19.09,10.44,32,13.57v23.37C36.41,141.4,24,132.39,24,124Zm64,48v-4.17c2.63.1,5.29.17,8,.17,3.88,0,7.67-.13,11.39-.35A121.92,121.92,0,0,0,120,171.41v23.46C100.41,189.4,88,180.39,88,172Zm48,26.25V174.4a179.48,179.48,0,0,0,24,1.6,183.74,183.74,0,0,0,24-1.54v23.79a165.45,165.45,0,0,1-48,0Zm64-3.38V171.5c12.91-3.13,23.84-7.79,32-13.57V172C232,180.39,219.59,189.4,200,194.87Z"></path></svg>&nbsp;<?php echo $row['coins'];?>.00 coins</h6>
                    </div>
                </div>
            </nav>
        </div>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand  navbar-dark sticky-top px-4 "  style="background-color: var(--primary-color); margin-top: 3vh; border: 5px transparent; border-radius: 25px; width: auto; margin-left: 20px; margin-right: 20px;" >
                ...
                <a href="#" style="color:var(--test-color);" class="sidebar-toggler flex-shrink-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown" >
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            font-family: Plus Jakarta Sans; height:70vh; background-color: white; border: 5px transparent; border-radius: 35px;  padding: 35px; width: 59vh;">
            ...
            <!-- Form Start -->
            <div class="container-fluid pt-4 px-4" style="margin: auto;">
                <div class="row g-4">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4" style="text-align: center; font-size: 30px;">Game Panel Details</h6>
                            <form method="post" >
                                <div class="mb-3">
                                    <label class="form-label" style="font-size: 16px;">E-Mail Account</label>
                                    <input type="text" class="form-control" value="<?php 
                                    echo $servers["E_mail"];
                                    ?>" id="myInput">
                                    <label class="form-label" style="font-size: 16px;">Password</label>
                                    <input type="text" class="form-control btn btn-primary" style="background-color:rgb(129, 129, 145);"value="<?php 
                                    echo $servers["password"];
                                    ?>" id="myInput">


                                </div>
                                <button class="btn btn-primary" onclick="myFunction()">Copy</button>       <a href="https://control.optikservers.com/" target="_Blank"><p class="btn"  style="background-color: #d4e01f;">Panel Link</p></a>
                            </form>
                    </div>
  ...
  alert("Copied the text: " + copyText.value);
            ...
            <!-- Footer Start -->
            <div style="vertical-align: bottom; color: var(--test-color);">
                <p style="text-align: center;">Made With 💝 By Rakin.</p>
            </div>
            <!-- Footer End -->
        </div>
        <!-- Content End -->
